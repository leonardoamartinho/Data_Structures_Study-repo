...
int main(void){
    TARVB *arvore = TARVB_Inicializa();
    int t = 2;
    arvore = TARVB_Insere(arvore,4,t);
    arvore = TARVB_Insere(arvore,8,t);
    arvore = TARVB_Insere(arvore,32,t);
    arvore = TARVB_Insere(arvore,45,t);
    arvore = TARVB_Insere(arvore,12,t);
    arvore = TARVB_Insere(arvore,9,t);
    arvore = TARVB_Insere(arvore,7,t);
    arvore = TARVB_Insere(arvore,23,t);
    arvore = TARVB_Insere(arvore,11,t);
    arvore = TARVB_Insere(arvore,10,t);
    arvore = TARVB_Insere(arvore,1,t);
    arvore = TARVB_Retira(arvore,12,t);
    arvore = TARVB_Retira(arvore,1,t);
    arvore = TARVB_Retira(arvore,32,t);
    arvore = TARVB_Retira(arvore,9,t);
    arvore = TARVB_Retira(arvore,23,t);
    TARVB_Imprime(arvore);

    /*TARVB *arvore = TARVB_Inicializa();
    int t = 2;
    arvore = TARVB_Insere(arvore,3,t);
    arvore = TARVB_Insere(arvore,1,t);
    arvore = TARVB_Insere(arvore,4,t);
    arvore = TARVB_Insere(arvore,8,t);
    arvore = TARVB_Insere(arvore,10,t);
    arvore = TARVB_Insere(arvore,2,t);
    arvore = TARVB_Insere(arvore,0,t);
    arvore = TARVB_Insere(arvore,15,t);
    arvore = TARVB_Retira(arvore,8,t);
    arvore = TARVB_Retira(arvore,3,t);
    arvore = TARVB_Retira(arvore,0,t);
    TARVB_Imprime(arvore);
