...
int main(void){
    ...
    a = TARVBM_insere(a,4,2);
    a = TARVBM_insere(a,8,2);
    a = TARVBM_insere(a,32,2);
    a = TARVBM_insere(a,45,2);
    a = TARVBM_insere(a,12,2);
    a = TARVBM_insere(a,9,2);
    a = TARVBM_insere(a,7,2);
    a = TARVBM_insere(a,23,2);
    a = TARVBM_insere(a,11,2);
    a = TARVBM_insere(a,10,2);
    a = TARVBM_insere(a,1,2);
    a = TARVBM_retira(a,12,2);
    a = TARVBM_retira(a,1,2);
    a = TARVBM_retira(a,32,2);
    a = TARVBM_retira(a,9,2);
    a = TARVBM_retira(a,23,2);
   
    TARVBM_imprime(a);

    /*TARVBM *arvore = TARVBM_inicializa();
    int t = 2;
    arvore = TARVBM_insere(arvore,3,t);
    arvore = TARVBM_insere(arvore,1,t);
    arvore = TARVBM_insere(arvore,4,t);
    arvore = TARVBM_insere(arvore,8,t);
    arvore = TARVBM_insere(arvore,10,t);
    arvore = TARVBM_insere(arvore,2,t);
    arvore = TARVBM_insere(arvore,0,t);
    arvore = TARVBM_insere(arvore,15,t);
    arvore = TARVBM_retira(arvore,8,t);
    arvore = TARVBM_retira(arvore,3,t);
    arvore = TARVBM_retira(arvore,0,t);
    TARVBM_imprime(arvore);
